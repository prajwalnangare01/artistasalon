...
function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-[60] flex items-center justify-between whitespace-nowrap bg-white px-3 sm:px-4 md:px-6 lg:px-10 py-2 sm:py-3 shadow-md">
