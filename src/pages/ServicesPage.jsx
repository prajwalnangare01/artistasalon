...
function ServicesPage() {
  ...
  const services = {
    ...
    nail_art: {
      ...
      items: [
        { name: "Nail Polish (Hand)", desc: "Nail polish application on hands.", price: "₹200" },
        { name: "Nail Polish (Feet)", desc: "Nail polish application on feet.", price: "₹250" },
        ...
        { name: "Acrylic Extension (Hand)", desc: "Acrylic nail extensions on hands.", price: "₹2000" },
        { name: "Acrylic Extension (Feet)", desc: "Acrylic nail extensions on feet.", price: "₹1800" },
